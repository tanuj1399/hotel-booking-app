...
public class Utils {
    ...
    public static UserDTO mapUserEntityToUserDTOPlusUserBookingsAndRoom(User user){
        ...
        if(!user.getBookings().isEmpty()){
            ...
            userDTO.setBookings(user.getBookings().stream()
                .map(booking -> mapBookingEntityToUserDTOPlusBookedRooms(booking, false)).collect(Collectors.toList()));
        }
    ...
    public static BookingDTO mapBookingEntityToUserDTOPlusBookedRooms(Booking booking, boolean mapUser){
